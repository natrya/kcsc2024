(function () {
    ...
    Runner.prototype = {
        ...
        KCSC_2024: function() {
        	...
        	var hr = this.run();
        	const flag = 37430033396524552526864243544821916216775625930059474151885074724325256021487107184576194n;
        	const p1 = 294704857459121458995842604700946850751n;
        	const p2 = 314052721216923470597325825556277950411n;
        	const res = 89003897114642089261057080980181861025309601157279125520776940699791620400147n;
        ...
        run: function() {
        	return BigInt(Math.floor(this.distanceRan));
        },
        /**
         * Game over state.
         */
	...
	function transform(longInt) {
		let bytes = [];
	    while (longInt > 0n) {
	        bytes.unshift(Number(longInt & 0xFFn));
	        longInt = longInt >> 8n;
	    }
